  ...
  try {
    ...
    const profile = await prisma.profile.create({
      data: {
        ...
        lastDivorceDate: req.body.lastDivorceDate,
        hasChildren: req.body.hasChildren,
        numberOfChildren: req.body.numberOfChildren,
        childrenDetails: req.body.childrenDetails,
        childrenCustody: req.body.childrenCustody,
        wantsPolygamy: req.body.wantsPolygamy,
        wantsChildren: req.body.wantsChildren,
        fatherOccupation: req.body.fatherOccupation,
        motherOccupation: req.body.motherOccupation,
        siblingsCount: req.body.siblingsCount,
        siblingsEducation: req.body.siblingsEducation,
        originGovernorate: req.body.originGovernorate,
        residenceGovernorate: req.body.residenceGovernorate,
        areaType: req.body.areaType,
        marriedResidence: req.body.marriedResidence,
        housingType: req.body.housingType,
        housingPrivacy: req.body.housingPrivacy,
        ...
        wifePreferredSkinColor: req.body.wifePreferredSkinColor,
        wifePreferredHijab: req.body.wifePreferredHijab,
        wifePreferredWork: req.body.wifePreferredWork,
        wifeAcceptDivorcedWithChildren: req.body.wifeAcceptDivorcedWithChildren,
        wifeAcceptDivorcedChildrenCustody: req.body.wifeAcceptDivorcedChildrenCustody,
        wifeAcceptOtherCity: req.body.wifeAcceptOtherCity,
        wifeFurnishApartment: req.body.wifeFurnishApartment,
