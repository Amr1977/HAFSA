      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-[#E5E7EB] dark:border-gray-700 p-8 md:p-10 transition-all duration-200">
          <div className="text-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-[#1B4332] dark:text-gray-100">تسجيل الدخول</h1>
            <p className="text-sm text-[#6B7280] dark:text-gray-400 mt-1">مرحباً بعودتك! سجل دخولك للمتابعة</p>
          </div>
          ...
          <button onClick={handleGoogle} disabled={googleLoading}
            ...
            <span className="text-[#374151] dark:text-gray-300 group-hover:text-[#1B4332] dark:group-hover:text-[#DAA520]">
              {googleLoading ? 'جاري التحميل...' : 'تسجيل الدخول باستخدام Google'}
            </span>
          </button>
          ...
          <div className="relative my-7">
            ...
            <div className="relative flex justify-center">
              <span className="bg-white dark:bg-gray-800 px-4 text-sm text-[#9CA3AF] dark:text-gray-500">أو بكلمة المرور</span>
            </div>
          </div>
